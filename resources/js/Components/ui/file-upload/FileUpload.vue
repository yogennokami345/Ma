<template>
  <ClientOnly>
    ...
    >
      <div
        class="group/file relative block w-full cursor-pointer overflow-hidden rounded-lg p-5"
        @click="handleClick"
      >
        <input
          ref="fileInputRef"
          ...
          <div class="relative mx-auto mt-10 w-full max-w-xl space-y-4">
            ...
            <template v-if="!files.length">
              <Motion
                ...
                "
              >
              <Icon icon="heroicons:arrow-up-tray" width="30" height="30" class="text-neutral-600 dark:text-neutral-400"/>
              </Motion>
